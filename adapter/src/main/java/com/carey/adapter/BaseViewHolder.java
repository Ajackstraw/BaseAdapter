...
public class BaseViewHolder<T extends View> extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder(Context context, View itemView) {
        ...
        itemChildLongClickViewIds = new LinkedHashSet<>();
    }
     ...
     * @param recyclerView
     */
    public static void setRecycleManager(Context context, RecyclerView recyclerView){
        setRecycleManager(context, recyclerView, VERTICAL, 1);
    }
     ...
     * @param recyclerView
     */
    public static void setRecycleManager(Context context, RecyclerView recyclerView, int type){
        setRecycleManager(context, recyclerView, type, 1);
    }
     ...
     * @param context
     * @param recyclerView
     * @param type recycleview type
     * @param size recycleview size
     */
    public static void setRecycleManager(Context context, RecyclerView recyclerView, int type, int size){
        if(type == VERTICAL){
            if(size == 1){
                ...
                GridLayoutManager gridLayoutManager = new GridLayoutManager(context, size, GridLayoutManager.HORIZONTAL, false);
     ...
     * @return
     */
    public BaseViewHolder setTextBold(@IdRes int viewId, boolean isBold) {
        TextView view = getView(viewId);
    ...
    public BaseViewHolder setTextPaint(@IdRes int viewId) {
        TextView view = getView(viewId);
    ...
    public BaseViewHolder setButtonText(@IdRes int viewId, CharSequence value) {
        Button view = getView(viewId);
        view.setText(value);
        return this;
    }

    public BaseViewHolder setButtonText(@IdRes int viewId, @StringRes int strId) {
        Button view = getView(viewId);
        view.setText(strId);
        return this;
    }

    public BaseViewHolder setViewLay(@IdRes int viewId, int width, int height) {
        View iv = getView(viewId);
        ViewGroup.LayoutParams linearParams = iv.getLayoutParams();
    ...
    public BaseViewHolder setViewLay(@IdRes int viewId, int width) {
        View iv = getView(viewId);
        ViewGroup.LayoutParams linearParams = iv.getLayoutParams();
    ...
    public BaseViewHolder setViewHeightLay(@IdRes int viewId, int height) {
        View iv = getView(viewId);
        ViewGroup.LayoutParams linearParams = iv.getLayoutParams();
        linearParams.height = height;
        iv.setLayoutParams(linearParams);
    ...
    public BaseViewHolder setViewWidthLay(@IdRes int viewId, int width) {
        View iv = getView(viewId);
        ViewGroup.LayoutParams linearParams = iv.getLayoutParams();
        linearParams.width = width;
        iv.setLayoutParams(linearParams);
     ...
     *
     * @param viewId The view id.
     * @param backgroundRes  A color, not a resource id.
     * @return The BaseViewHolder for chaining.
     */
    public BaseViewHolder setBackground(@IdRes int viewId, Drawable backgroundRes) {
    ...
    public BaseViewHolder setSelect(@IdRes int viewId, boolean isSelect) {
        View view = getView(viewId);
